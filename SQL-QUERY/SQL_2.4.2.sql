...
BEGIN
    ...
    ELSE
        ...
        read_loop: LOOP
            ...
            IF v_status = 'Finish' THEN
                IF v_amount_str IS NOT NULL AND v_amount_str <> 'Free' THEN
                    SET v_amount_num = CAST(SUBSTRING_INDEX(v_amount_str, ' ', 1) AS DECIMAL(18,2));
